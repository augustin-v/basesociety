...
interface IERC7857DataVerifier {
    ...
    function verifyTransferValidity(TransferValidityProof[] calldata _proofs)
        external
        returns (TransferValidityProofOutput[] memory);

    /// @notice Mock function for verifying data transfer validity for MVP.
    /// @param _proofs Proofs generated by TEE/ZKP
